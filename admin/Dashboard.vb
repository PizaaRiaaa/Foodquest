...
Public Class Dashboard
    ...
    Sub LoadChart()
        ...
        Dim da As New MySqlDataAdapter("select name,stocks from tbl_products where stocks <= '" & admin_form.min & "'", conn)
        Dim ds As New DataSet
        da.Fill(ds, "Stocks")
    ...
    End Sub
    Private Sub Dashboard_Load_1(sender As Object, e As EventArgs) Handles MyBase.Load
        RoundCorners(Me)
        LoadingInstore()
        LoadingOnline()
        LoadInStoreSales()
