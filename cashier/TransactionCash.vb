...
Public Class TransactionCash
    ...
    Private Sub Transaction_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        MasterData = "                       Food Quest Supermarket                                                 " & vbLf &
                      ...
                      "         CASH: " + "                           " + lblCash.Text & vbLf & vbLf &
                      "         Discount: " + "                           " + lblDisAmount.Text & vbLf & vbLf &
                      "         CHANGE DUE: " + "                     " + lblChange.Text & vbLf & vbLf &
                      "-----------------------------------------------------------------" & vbLf & vbLf &
    ...
    Private Sub lblVatableSale_Click(sender As Object, e As EventArgs) Handles lblVatableSale.Click

    End Sub

    Private Sub lav_Click(sender As Object, e As EventArgs) Handles lav.Click
    ...
    Private Sub lvs_Click(sender As Object, e As EventArgs) Handles lvs.Click
    ...
    Private Sub Label5_Click(sender As Object, e As EventArgs) Handles lblDot.Click
